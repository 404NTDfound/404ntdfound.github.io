...
function iFocusChange() {
    ...
    if (listLength>=4) {
        iFocusBtns[3].onmouseover = function() {
            moveElement('ifocus_piclist',0,-1655,5);
            classNormal('ifocus_btn','ifocus_tx');
    ...
    if (listLength>=5) {
        iFocusBtns[4].onmouseover = function() {
            moveElement('ifocus_piclist',0,-2175,5);
            classNormal('ifocus_btn','ifocus_tx');
    ...
    if (listLength>=6) {
        iFocusBtns[5].onmouseover = function() {
            moveElement('ifocus_piclist',0,-2710,5);
            classNormal('ifocus_btn','ifocus_tx');
...
function autoiFocus() {
    ...
    if (currentNum==3&&listLength!=4 ){
        moveElement('ifocus_piclist',-1675,5);
        classNormal('ifocus_btn','ifocus_tx');
        classCurrent('ifocus_btn','ifocus_tx',3);
    }
    if (currentNum==4&&listLength!=5 ){
        moveElement('ifocus_piclist'-2175,5);
        classNormal('ifocus_btn','ifocus_tx');
        classCurrent('ifocus_btn','ifocus_tx',3);
    }
    if (currentNum==5 ){
